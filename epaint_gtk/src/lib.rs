...
pub mod properties {
    ...
    Granulation, LightFastness, Opacity, Staining};
...
pub mod colour {
    ...
    use epaint::mixtures::{MixtureIfce};
    use epaint::paint::PropertiedPaintPlus;

    // impl<M: MixtureIfce> PartsColour for M {}
    impl<P: PropertiedPaintPlus> PartsColour for P {}
}
